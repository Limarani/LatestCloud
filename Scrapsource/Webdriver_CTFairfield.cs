                    ...
                    if (countTax == "0")//Bridgeport
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                ...
                                Thread.Sleep(2000);
                                IWebElement ITaxDownSelect1 = driver1.FindElement(By.Id("actionType"));
                                SelectElement sTaxDownSelect1 = new SelectElement(ITaxDownSelect1);
                                sTaxDownSelect1.SelectByText("Unique ID");
                                driver1.FindElement(By.XPath("//*[@id='uniqueid']/input[1]")).SendKeys(uniqueidMap);
                                driver1.FindElement(By.Id("searchbtn4")).SendKeys(Keys.Enter);
                                Thread.Sleep(3000);
