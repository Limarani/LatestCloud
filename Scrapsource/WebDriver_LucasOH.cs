        ...
        public string FTP_LucasOH(string houseno, string Direction, string sname, string stype, string unitno, string parcelNumber, string ownername, string searchType, string orderNumber)
        {
            ...
            using (driver = new PhantomJSDriver()) //ChromeDriver
            {
                try
                {
                    ...
                    //Yearbuilt Click
                    driver.FindElement(By.LinkText("Residential Attributes")).Click();
                    Thread.Sleep(2000);
                    ...
                    try
                    {
                        ...
                        Thread.Sleep(2000);
                        gc.CreatePdf(orderNumber, Parcelid, "Permit Extra", driver, "OH", "Lucas");
                    }
                    catch { }
                    try
                    {
                    ...
                    try
                    {
                        driver.FindElement(By.LinkText("      By Fund")).Click();
                        Thread.Sleep(2000);
                    ...
                    try
                    {
                        ...
                        driver.FindElement(By.LinkText("      By Fund & Levy")).Click();
                        Thread.Sleep(2000);
                    ...
                    driver.FindElement(By.LinkText("Prior Taxes")).Click();
                    Thread.Sleep(2000);
                    ...
                    driver.FindElement(By.LinkText("Special Assessments")).Click();
                    Thread.Sleep(2000);
                    ...
                    driver.FindElement(By.LinkText("Prior Specials")).Click();
                    Thread.Sleep(2000);
